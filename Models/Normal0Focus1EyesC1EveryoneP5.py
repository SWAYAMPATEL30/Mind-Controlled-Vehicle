...
data = pd.read_csv('C:\\Users\\rutuj\\OneDrive\\Documents\\GitHub\\FinalYearProject\\Normal0Focus1EyesC1EveryoneP5.csv')
data1 = data.dropna()
...
joblib.dump(model,'Normal0Focus1EyesC1EveryoneP5.pkl')
