...
data = pd.read_csv('C:\\Users\\rutuj\\OneDrive\\Documents\\GitHub\\FinalYearProject\\NormalFocusEyesCEveryoneP5.csv')
data1 = data.dropna()
...
joblib.dump(model,'NormalFocusEyesCEveryoneP5.pkl')
