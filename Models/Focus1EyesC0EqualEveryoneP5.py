...
eyes closed value-0
Accuracy-69
Equal focus & eyes closed values
"""

data = pd.read_csv('C:\\Users\\rutuj\\OneDrive\\Documents\\GitHub\\FinalYearProject\\Focus1EyesC0EqualEveryoneP5.csv')
data1 = data.dropna()
...
joblib.dump(model,'Focus1EyesC0EqualEveryoneP5.pkl')
